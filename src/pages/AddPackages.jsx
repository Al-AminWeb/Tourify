...
const AddPackage = () => {
    ...
    if (!user) {
        return (
            <div className="min-h-screen flex items-center justify-center">
                <p>Please log in to add a package.</p>
            </div>
        );
    }
    ...
    return (
        <div
            ...
            style={{
                backgroundImage:
                    "url('https://images.pexels.com/photos/3823039/pexels-photo-3823039.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')",
            }}
        >
                ...
                <form onSubmit={handleAddPackage} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="form-control">
                            ...
                            <input type="text" name="tour_name" placeholder="e.g., Sundarbans Expedition" className="input input-bordered w-full" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text font-semibold">Image URL</span>
                            </label>
                            <input type="url" name="image" placeholder="https://example.com/image.jpg" className="input input-bordered w-full" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            ...
                            <input type="number" name="price" placeholder="e.g., 350" className="input input-bordered w-full" required />
                        </div>
                        <div className="form-control">
                            <label className="label">
                        ...
                        <div className="form-control">
                            <label className="label">
                                <span className="label-text font-semibold">Guide Contact No.</span>
                            </label>
                            <input type="tel" name="guide_contact_no" placeholder="e.g., 01712345678" className="input input-bordered w-full" required />
                        </div>
                    </div>
                    ...
                    <div className="form-control">
                        ...
                        <textarea name="package_details" className="textarea textarea-bordered h-28 w-full" placeholder="Describe the tour itinerary, what's included..." required></textarea>
                    </div>
